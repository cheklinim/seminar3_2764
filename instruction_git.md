...
Для работы с репозиторием другого человека – находим ссылку 9копируем. В новой папке открываем терминал и вводим «git clone» + ссылка. Затем «c»d + имя папки нужной.

Не забываем отрабатывать стандартными командами из собственной инструкции.