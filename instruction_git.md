...
Для этого потребуеся команда - git clone ссылка

Для работы нам потребуется создать новую ветку, перейти в нее и работать в ней.
Для этого потребуется выполнить команды:
git branch remoted
...
Делается это выполнением команды:  git push
